...
namespace UltimateCC
{
    public class PlayerMain : MonoBehaviour
    {
        ...
        [NonSerialized] public InputHandler InputHandler; // The PlayerInputManager handles all user input and sends it to the state machine.
        ...
        private void Awake()
        {
            ...
            foreach (var jump in PlayerData.Jump.Jumps)
                jump.currentJumpType = jump.LongJump;
